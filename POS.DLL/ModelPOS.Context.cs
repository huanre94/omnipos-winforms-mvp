...
namespace POS.DLL
{
    ...
    public partial class POSEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_Supervisor_Validate1_Result> SP_Supervisor_Validate1(string barcode)
        {
            var barcodeParameter = barcode != null ?
                new ObjectParameter("barcode", barcode) :
                new ObjectParameter("barcode", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_Supervisor_Validate1_Result>("SP_Supervisor_Validate1", barcodeParameter);
        }
    }
}
